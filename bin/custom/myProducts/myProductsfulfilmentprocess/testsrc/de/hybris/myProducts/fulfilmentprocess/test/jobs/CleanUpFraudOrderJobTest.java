 ...
 */
package de.hybris.myProducts.fulfilmentprocess.test.jobs;
...
import de.hybris.myProducts.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = MyProductsFulfilmentProcessConstants.ORDER_PROCESS_NAME;
