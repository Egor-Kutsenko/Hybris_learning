 ...
 */
package de.hybris.myProducts.test.setup;
...
import de.hybris.myProducts.test.constants.MyProductsTestConstants;
import de.hybris.myProducts.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MyProductsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/myProductstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/myProductstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/myProductstest/import/cstickets.impex");
			...
			importImpexFile(context, "/myProductstest/import/csquotes.impex");
		}
	}
}
