 ...
 */
package de.hybris.myProducts.core.suggestion;
...
import de.hybris.myProducts.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/myProductscore/test/testSimpleSuggestionService.csv", "utf-8");
	}
