...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/myProductsstorefront/electronics/en",
						"https://electronics.local:9002/myProductsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/myProductsstorefront/electronics/en",
						"https://electronics.local:9002/myProductsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/myProductsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/myProductsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/myProductsstorefront/electronics/en",
						"https://electronics.local:9002/myProductsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/myProductsstorefront",
						"https://electronics.local:9002/myProductsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/myProductsstorefront",
						"https://electronics.local:9002/myProductsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/myProductsstorefront/electronics/en",
						"https://electronics.local:9002/myProductsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
